<template>
  <div class="tags-container">
    ...
    <div ref="tagBox" class="tags-box">
      <div
        ref="tagsList" class="tags-list" @mousewheel="hadelMousewheel"
        @mouseup="hadelMouseUp" @mousemove="hadelMouse" @mousedown="hadelMousestart"
        @touchup="hadelMouseUp" @touchmove="hadelMouse" @touchstart="hadelMousestart"
      >
        <div
          v-for="(item,index) in tagList" ref="tagsPageOpened" :key="index"
